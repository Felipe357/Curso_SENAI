...
select c.Cliente_id, c.nome, c.logradouro, c.numero, c.complemento, c.bairro, c.referencia, t.telefone as telefone from clientes c
...
("Bento Rafael Siqueira","Rua Sergio Willians Poneli",1218,"","Dom Bosco",""),
