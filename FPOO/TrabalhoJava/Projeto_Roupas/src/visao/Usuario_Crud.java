...
public class Usuario_Crud extends JFrame implements ActionListener {
	...
	private JButton cadastrar, buscarProduto, apagar, mudarVendedor, mudarTela;
	...
	Usuario_Crud() {
		...
		mudarTela = new JButton("Vendas");

		cadastrar.setBounds(190, 140, 100, 30);
		buscarProduto.setBounds(315, 140, 100, 30);
		mudarVendedor.setBounds(440, 140, 100, 30);
		mudarVendedor.setEnabled(false);
		apagar.setBounds(555, 140, 100, 30);
		apagar.setEnabled(false);
		mudarTela.setBounds(675, 140, 100, 30);

		cadastrar.addActionListener(this);
		buscarProduto.addActionListener(this);

		apagar.addActionListener(this);
		mudarTela.addActionListener(this);

		//
		painel.add(mudarTela);
